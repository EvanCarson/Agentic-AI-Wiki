...
const group: Group = {
  ...
  { page: 'multilingual-voice-agents', slug: 'multilingual-voice-agents', title: L('Multilingual &amp; Code-Switching Voice Agents','多语言与语码转换语音智能体'), summary: L('Adding a language breaks recognition, not generation — and per-turn language lock, the standard fix, is exactly what a bilingual caller violates in their first sentence, with the damage landing on the names and numbers you were about to pass to a tool.','多加一种语言坏掉的是识别而不是生成——而按轮锁定语言这个标准解法，恰恰会被双语来电者的第一句话打破，而受损的正是你正要传给工具的那些人名与号码。') },
  ],
};
