// Aggregator for the Operations advanced essays.
//
// Each Operation GROUP lives in its own file under `./groups/<key>.ts` — one
...
//
// To add a new group: create `src/content/operations/groups/<short-key>.ts`
