// Aggregator for the Deep-Dives advanced essays.
//
// Each Deep-Dive GROUP lives in its own file under `./groups/<key>.ts` — one
...
//
// To add a new group: create `src/content/deep-dives/groups/<short-key>.ts`
